...
class TrajeectorySaver:
    def __init__(self, file_path):
        ...
        self.color_sub = rospy.Subscriber("/drawing_color_", Int32, self.callback_color_)
    ...
    def callback_traj(self, msg):
        ...
        self.file_path = self.file_path_init + str(self.file_num) + '.yaml'
    ...
    def callback_color_(self, msg):
        if self.arm_num != -1:
            self.color = str(msg.data)
            self.file_num = 0
            print('message recieved: ' + self.color)
