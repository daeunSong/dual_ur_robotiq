...
class DrawingInput {
  public:
    ...
    point_t getQuaternion(double x, point_t &sn);
    point_t getCrossProduct(point_t &a, point_t &b);
    double getVectorSize(point_t &normal);
    tf::Matrix3x3 getRotationMatrix(point_t &axis, double c);
