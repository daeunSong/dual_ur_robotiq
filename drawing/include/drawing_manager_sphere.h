...
class DrawingManager {
  public:
    ...
    const std::string PEN_LINK_R = "right_pen_tool0";
    const std::string PEN_LINK_L = "left_pen_tool0";
...
//    ros::Publisher arm_num_pub_2;
    ...
    ros::Publisher drawing_comm_r;
    ros::Publisher drawing_comm_l;
    ros::Publisher tool_comm_r;
    ros::Publisher tool_comm_l;
    ros::Subscriber drawing_state_r;
    ros::Subscriber drawing_state_l;
    ros::Subscriber tool_state_r;
    ros::Subscriber tool_state_l;
    ros::Publisher trajectory_pub_r;
    ros::Publisher trajectory_pub_l;
    ros::Publisher drawing_traj_pub_r;
    ros::Publisher drawing_traj_pub_l;

    int ready_to_draw = 0;
    int tool_change_r_done = 0;
    int tool_change_l_done = 0;
    int drawing_r_done = 1;
    int drawing_l_done = 1;

    geometry_msgs::Pose init_drawing_pose_r;
    geometry_msgs::Pose init_drawing_pose_l;

    void drawCallback_r(const std_msgs::Int32::ConstPtr& msg);
    void drawCallback_l(const std_msgs::Int32::ConstPtr& msg);

    void toolCallback_r(const std_msgs::Int32::ConstPtr& msg);
    void toolCallback_l(const std_msgs::Int32::ConstPtr& msg);
    ...
    void initPose ();
    void left_drawing_initPose();
    void right_drawing_initPose();
    void initPose_r ();
    void initPose_l ();
    ...
    void pick_tool(int i);
    void place_tool(int i);
